...
![Dev Flow Kit Screenshot](./public/screenshot.png)
...
快速调用摄像头，化身精致开发者的临时“仪表镜”。

- **镜像模式**：完全模拟真实镜子视觉效果（水平翻转）。
- **动态缩放**：支持视窗调大与恢复，适配不同屏幕与细节观察需求。
- **一键拍照**：实时捕捉，支持所见即所得的镜像照片下载。
